...
public final class DigitalLibraryConstants {

	public static final String PAPERBACK = "Brochura";
	...
	public static final String ADD_AUTOR_SUCCESS = "Autor adicionado com sucesso";
	public static final String ADD_CATEGORY_FAILURE = "Houve falha em adicionar categoria";
	public static final String ADD_AUTOR_FAILURE = "Houve falha em adicionar autor";
	...
	public static final String REMOVE_AUTOR_FAILURE = "Houve falha em remover autor";	
	public static final String REMOVE_AUTOR_SUCCESS = "Autor removido com sucesso";
	public static final String UPDATE_CATEGORY_SUCCESS = "Categoria alterada com sucesso";
	public static final String UPDATE_AUTOR_SUCCESS = "Autor alterado com sucesso";
	public static final String UPDATE_CATEGORY_FAILURE = "Houve falha em alterar categoria";
	public static final String UPDATE_AUTOR_FAILURE = "Houve falha em alterar autor";
